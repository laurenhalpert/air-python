...
if __name__ == '__main__':
    ...
    def make_reservation():
        ...
        if choose_flight == 'go back':
            ...
            flight_details = book_flight(choose_flight, passenger_name, passenger_age, passenger_budget)
            print('')
            print(f'You\'re booked! Here is your reference code: {flight_details.reference_code}')
            print('')
            res_tuple = (flight_details.passenger, flight_details.flight)
            print(f'Here is your reservation info: ')
            print(res_tuple)
            print('')
            print('Thanks for visiting!')
